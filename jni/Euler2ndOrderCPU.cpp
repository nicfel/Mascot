...
void Euler2ndOrderCPU::init(double * migration_rates, int rateCount, double * coalescent_rates, int lineages, int states, double epsilon, double max_step) {
...
void Euler2ndOrderCPU::initWithIndicators(double * migration_rates, int * indicators, double * coalescent_rates, int lineages, int states, double epsilon, double max_step) {
//		(*this).max_step = max_step;
//		(*this).epsilon = epsilon;
//		(*this).migration_rates = migration_rates;
...
void Euler2ndOrderCPU::setup(int maxSize) {
