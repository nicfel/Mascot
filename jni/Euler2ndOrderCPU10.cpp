...
Euler2ndOrderCPU10::Euler2ndOrderCPU10() {
	fprintf(stderr, "Creating Euler2ndOrderCPU10\n");
...
void Euler2ndOrderCPU10::init(double * migration_rates, int rateCount, double * coalescent_rates, int lineages) {
...
void Euler2ndOrderCPU10::initWithIndicators(double * migration_rates, int * indicators, double * coalescent_rates, int lineages) {
...
void Euler2ndOrderCPU10::setup(int maxSize, int states, double epsilon, double max_step) {
...
void Euler2ndOrderCPU10::setUpDynamics(int count, double * migration_rates, double * coalescent_rates, double * next_rate_shift) {
	if (	rateShiftCount == 0) {
...
void Euler2ndOrderCPU10::calculateValues(double duration, double * p, int length) {
...
//void Euler2ndOrderCPU10::calculateValues(double duration, double * p, double * pDot, double * pDotDot, double * pDotDotDot) {
//		calculateValues(duration, p, pDot, pDotDot, pDotDotDot, pDot.length);
//	}

void Euler2ndOrderCPU10::calculateValues(double duration, double * p, double * pDot, double * pDotDot, double * pDotDotDot, int length) {
...
double Euler2ndOrderCPU10::updateP (double duration, double * p, double * pDot, double * pDotDot, double * pDotDotDot, int length) {
...
double Euler2ndOrderCPU10::maxAbs(double * pDotDotDot, int length) {
...
void Euler2ndOrderCPU10::normalise(const int i, double * p) {
...
void Euler2ndOrderCPU10::updateP2(const double timeStep, const double timeStepSquare, double * p, const int length, double * pDot,
			double * pDotDot) {
		for (int i = 0; i < length; i++) {
			p[i] += pDot[i] * timeStep;
...
void Euler2ndOrderCPU10::computeDerivatives (double * p, double * pDot, double * pDotDot, double * pDotDotDot, int length) {
...
void Euler2ndOrderCPU10::calcSumStates(double  * sumStates, const double * p) {
		int u = 0;
		for (int i = 0; i < lineages; i++) {
...
void Euler2ndOrderCPU10::computeSecondDerivate (double * p, double * pDot, double * pDotDot, int length) {
...
void Euler2ndOrderCPU10::approximateThirdDerivate (double * pDotDot, double * pDotDotDot, int length) {
		double migrates;
...
void Euler2ndOrderCPU10::computeDerivativesWithMultiplicator(double * p, double * pDot, double * pDotDot, double * pDotDotDot, int length) {
...
void Euler2ndOrderCPU10::computeSecondDerivateWithMultiplicator(double * p, double * pDot, double * pDotDot, int length) {
