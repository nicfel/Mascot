...
Euler2ndOrderCPU12::Euler2ndOrderCPU12() {
	fprintf(stderr, "Creating Euler2ndOrderCPU12\n");
...
void Euler2ndOrderCPU12::init(double * migration_rates, int rateCount, double * coalescent_rates, int lineages) {
...
void Euler2ndOrderCPU12::initWithIndicators(double * migration_rates, int * indicators, double * coalescent_rates, int lineages) {
...
void Euler2ndOrderCPU12::setup(int maxSize, int states, double epsilon, double max_step) {
...
void Euler2ndOrderCPU12::setUpDynamics(int count, double * migration_rates, double * coalescent_rates, double * next_rate_shift) {
	if (	rateShiftCount == 0) {
...
void Euler2ndOrderCPU12::calculateValues(double duration, double * p, int length) {
...
//void Euler2ndOrderCPU12::calculateValues(double duration, double * p, double * pDot, double * pDotDot, double * pDotDotDot) {
//		calculateValues(duration, p, pDot, pDotDot, pDotDotDot, pDot.length);
//	}

void Euler2ndOrderCPU12::calculateValues(double duration, double * p, double * pDot, double * pDotDot, double * pDotDotDot, int length) {
...
double Euler2ndOrderCPU12::updateP (double duration, double * p, double * pDot, double * pDotDot, double * pDotDotDot, int length) {
...
double Euler2ndOrderCPU12::maxAbs(double * pDotDotDot, int length) {
...
void Euler2ndOrderCPU12::normalise(const int i, double * p) {
...
void Euler2ndOrderCPU12::updateP2(const double timeStep, const double timeStepSquare, double * p, const int length, double * pDot,
			double * pDotDot) {
...
void Euler2ndOrderCPU12::computeDerivatives (double * p, double * pDot, double * pDotDot, double * pDotDotDot, int length) {
...
void Euler2ndOrderCPU12::calcSumStates(double  * sumStates, const double * p) {
...
void Euler2ndOrderCPU12::computeSecondDerivate (double * p, double * pDot, double * pDotDot, int length) {
...
void Euler2ndOrderCPU12::approximateThirdDerivate (double * pDotDot, double * pDotDotDot, int length) {
		double migrates;
...
void Euler2ndOrderCPU12::computeDerivativesWithMultiplicator(double * p, double * pDot, double * pDotDot, double * pDotDotDot, int length) {
...
void Euler2ndOrderCPU12::computeSecondDerivateWithMultiplicator(double * p, double * pDot, double * pDotDot, int length) {
