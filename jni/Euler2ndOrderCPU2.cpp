...
Euler2ndOrderCPU2::Euler2ndOrderCPU2() {
	fprintf(stderr, "Creating Euler2ndOrderCPU2\n");
...
void Euler2ndOrderCPU2::init(double * migration_rates, int rateCount, double * coalescent_rates, int lineages) {
...
void Euler2ndOrderCPU2::initWithIndicators(double * migration_rates, int * indicators, double * coalescent_rates, int lineages) {
...
void Euler2ndOrderCPU2::setup(int maxSize, int states, double epsilon, double max_step) {
...
//void Euler2ndOrderCPU2::calculateValues(double duration, double * p, double * pDot, double * pDotDot, double * pDotDotDot) {
//		calculateValues(duration, p, pDot, pDotDot, pDotDotDot, pDot.length);
//	}

void Euler2ndOrderCPU2::calculateValues(double duration, double * p, double * pDot, double * pDotDot, double * pDotDotDot, int length) {
...
double Euler2ndOrderCPU2::updateP (double duration, double * p, double * pDot, double * pDotDot, double * pDotDotDot, int length) {
...
double Euler2ndOrderCPU2::maxAbs(double * pDotDotDot, int length) {
...
void Euler2ndOrderCPU2::computeDerivatives (double * p, double * pDot, double * pDotDot, double * pDotDotDot, int length) {
...
void Euler2ndOrderCPU2::computeSecondDerivate (double * p, double * pDot, double * pDotDot, int length) {
...
void Euler2ndOrderCPU2::approximateThirdDerivate (double * pDotDot, double * pDotDotDot, int length) {
		double migrates;
...
void Euler2ndOrderCPU2::computeDerivativesWithMultiplicator(double * p, double * pDot, double * pDotDot, double * pDotDotDot, int length) {
...
void Euler2ndOrderCPU2::computeSecondDerivateWithMultiplicator(double * p, double * pDot, double * pDotDot, int length) {
