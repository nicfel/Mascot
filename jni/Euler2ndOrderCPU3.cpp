...
Euler2ndOrderCPU3::Euler2ndOrderCPU3() {
	fprintf(stderr, "Creating Euler2ndOrderCPU3\n");
...
void Euler2ndOrderCPU3::init(double * migration_rates, int rateCount, double * coalescent_rates, int lineages) {
...
void Euler2ndOrderCPU3::initWithIndicators(double * migration_rates, int * indicators, double * coalescent_rates, int lineages) {
...
void Euler2ndOrderCPU3::setup(int maxSize, int states, double epsilon, double max_step) {
...
void Euler2ndOrderCPU3::setUpDynamics(int count, double * migration_rates, double * coalescent_rates, double * next_rate_shift) {
	if (	rateShiftCount == 0) {
...
void Euler2ndOrderCPU3::calculateValues(double duration, double * p, int length) {
...
//void Euler2ndOrderCPU3::calculateValues(double duration, double * p, double * pDot, double * pDotDot, double * pDotDotDot) {
//		calculateValues(duration, p, pDot, pDotDot, pDotDotDot, pDot.length);
//	}

void Euler2ndOrderCPU3::calculateValues(double duration, double * p, double * pDot, double * pDotDot, double * pDotDotDot, int length) {
...
double Euler2ndOrderCPU3::updateP (double duration, double * p, double * pDot, double * pDotDot, double * pDotDotDot, int length) {
...
double Euler2ndOrderCPU3::maxAbs(double * pDotDotDot, int length) {
...
void Euler2ndOrderCPU3::normalise(const int i, double * p) {
...
void Euler2ndOrderCPU3::updateP2(const double timeStep, const double timeStepSquare, double * p, const int length, double * pDot,
			double * pDotDot) {
		for (int i = 0; i < length; i++) {
...
void Euler2ndOrderCPU3::computeDerivatives (double * p, double * pDot, double * pDotDot, double * pDotDotDot, int length) {
...
void Euler2ndOrderCPU3::calcSumStates(double  * sumStates, const double * p) {
...
void Euler2ndOrderCPU3::computeSecondDerivate (double * p, double * pDot, double * pDotDot, int length) {
...
void Euler2ndOrderCPU3::approximateThirdDerivate (double * pDotDot, double * pDotDotDot, int length) {
		double migrates;
...
void Euler2ndOrderCPU3::computeDerivativesWithMultiplicator(double * p, double * pDot, double * pDotDot, double * pDotDotDot, int length) {
...
void Euler2ndOrderCPU3::computeSecondDerivateWithMultiplicator(double * p, double * pDot, double * pDotDot, int length) {
