...
public class GLMConstant extends Dynamics implements Loggable {	
    
	public Input<GLMmodel> migrationGLMInput = new Input<>(
			"migrationGLM", "input of migration GLM model");
    public Input<RealParameter> migrationRatesInput = new Input<>(
    		"migrationParameter", "input of migration covariates scaler",
    		Validate.XOR, migrationGLMInput);    
    
	public Input<GLMmodel> NeGLMInput = new Input<>(
			"NeGLM", "input of migration GLM model");
    public Input<RealParameter> NeInput = new Input<>(
    		"NeParameter", "input of migration covariates scaler", 
    		Validate.XOR, NeGLMInput);    
